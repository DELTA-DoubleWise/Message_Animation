...
class Toolbox:
    def __init__(self, datasets_root, enc_models_dir, syn_models_dir, voc_models_dir, seed, no_mp3_support, filename, gen_text):
        ...
        with open(gen_text) as f:
            self.contents = f.read()

        # Initialize the events and the interface
        self.ui = UI()
        self.reset_ui(enc_models_dir, syn_models_dir, voc_models_dir, seed)
        self.setup_events(filename)
        self.ui.start()
    ...
    def setup_events(self,filename):
    ...
    def load(self, path):
        wav = Synthesizer.load_preprocess_wav(path)
        self.add_real_utterance(wav, "voice001", "author")
    ...
    def vocode(self):
        ...
        wavfile.write(f"./samples/gen/gen_001.wav",Synthesizer.sample_rate,wav)
