...
class Tool:
    def __init__(self, datasets_root, enc_models_dir, syn_models_dir, voc_models_dir, seed, no_mp3_support, filename):
    ...
    def synthesize(self):
        ...
        texts = "Welcome to the toolbox! To begin, load an utterance from your datasets or record one"
